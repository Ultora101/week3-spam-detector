...
class SpamDetector:
    ...
    def visualize_data(self):
        ...
        axes[0,0].hist([self.data[self.data['is_spam']==0]['word_count'], self.data[self.data['is_spam']==1]['word_count']], label=['Normal', 'Spam'], alpha=0.7, bins=10)
        ...
        axes[0,1].bar(['Normal', 'Spam'], [self.data[self.data['is_spam']==0]['exclamations'].mean(), self.data[self.data['is_spam']==1]['exclamations'].mean()])
        axes[0,1].set_ylabel('Average Exclamation Marks')
        axes[0,1].set_title('Exclamation Usage')

        # Plot 3: Money words
        axes[1,0].bar(['Normal', 'Spam'], [self.data[self.data['is_spam']==0]['money_words'].mean(), self.data[self.data['is_spam']==1]['money_words'].mean()])
